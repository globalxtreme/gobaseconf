...
type LogServiceClient interface {
	Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LGResponse, error)
}
...
func (c *logServiceClient) Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LGResponse, error) {
	out := new(LGResponse)
...
type LogServiceServer interface {
	Log(context.Context, *LogRequest) (*LGResponse, error)
...
func (UnimplementedLogServiceServer) Log(context.Context, *LogRequest) (*LGResponse, error) {
